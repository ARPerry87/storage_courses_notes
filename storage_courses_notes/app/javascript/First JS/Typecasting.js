...
console.log("Type of boolean casts to Number : ", typeof(boolean_num));
console.log("Value of boolean cast to Number : ", boolean_num);

let date_str = String(date);
console.log("Type of date_str casts to Number : ", typeof(date_str));
console.log("Value of date_str cast to Number : ", date_str);

let date_num = Number(date);

console.log("Type of date_num cast to Number : ", typeof(date_num));
console.log("Value of date_num cast to Number : ", date_num);
